...
# data = []
data = pd.read_csv('/Users/jorgeajimenez/repos/brassbunny/tools/DrugBank.csv')
    ...
    try:
        ...
        for i, record in data.iterrows():
            ...
            if (d1id == result and d2id == result_2) or (d1id == result_2 and d2id == result):
                record = interaction_map_hacky[record['Y']].replace('Drug1', drug_name).replace('Drug2', drug_name_2)
                return record
